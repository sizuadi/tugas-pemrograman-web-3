...
(function (global, factory) {
	...
	var Core = (function () {
		return {
			...
			imagesLoaded: function (el) {
				...
				if (len < 1) {
					Core.addEvent(el, "TravelImagesLoaded");
				}
	...
	var Modules = (function () {
		return {
			...
			travelSlider: function (element) {
				CNVS.TravelSlider &&
					CNVS.TravelSlider.init(element ? element : ".swiper_wrapper");
			},
			...
			ajaxButton: function (element) {
				CNVS.AjaxButton &&
					CNVS.AjaxButton.init(element ? element : "[data-ajax-loader]");
			},
...
(function (global, factory) {
	...
	return {
			...
			var _reset = function () {
				...
				__core.getVars.elPrimaryMenus.forEach(function (el) {
					if (!body.classList.contains("is-expanded-menu")) {
						...
						__core.getVars.elPrimaryMenus.forEach(function (el) {
							el.querySelectorAll(".mobile-primary-menu")?.forEach(function (
								elem
							) {
		...
		/**
		 * --------------------------------------------------------------------------
		 * TravelSlider Functions Start
		 * --------------------------------------------------------------------------
		 */
		TravelSlider: (function () {
			return {
				init: function (selector) {
					if (__core.getSelector(selector, false, false).length < 1) {
						return true;
			...
			var _get = function (element, loader, limit, fetchAlert) {
				...
				fetch(loader)
					...
					.then(function (images) {
						...
						element.addEventListener("TravelImagesLoaded", function () {
							__modules.masonryThumbs();
							__modules.lightbox();
						});
					})
					...
					selector.forEach(function (el) {
						el.onclick = function (e) {
							...
							var trigger = el,
								...
								elTriggerHide =
									el.getAttribute("data-ajax-trigger-hide") || "true",
								elTriggerDisable =
				...
				init: function (selector) {
					...
					__core
						...
						.then(function (cond) {
							...
							document.querySelectorAll(".travel-tabs").forEach(function (el) {
